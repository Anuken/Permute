...
public class Vars{
	...
	public static final String[] tutorialText = {
		...
		"- You can duplicate unit types by merging them",
		"with a unit of a lower type,",
		" then splitting them agian.",
		"",
		"[SKY]Shapes get XP when they kill others.",
		"When a shake gets enough XP, ",
		"they level up.",
		"",
		"[crimson]Units can also acquire random mutations ",
		"from other shapes when they kill them.",
		"",
		"[royal]The objective is to defend the base,",
